  ...
  switch (model) {
    ...
    default:  // Assume everything else does.
      ...
      switch (this->getSwing()) {
        case kFujitsuAcSwingOff:   result += F("Off"); break;
        case kFujitsuAcSwingVert:  result += F("Vert"); break;
        case kFujitsuAcSwingHoriz: result += F("Horiz"); break;
        case kFujitsuAcSwingBoth:  result += F("Vert + Horiz"); break;
        default:                   result += F("UNKNOWN");
      }
  }
  result += F(", Command: ");
