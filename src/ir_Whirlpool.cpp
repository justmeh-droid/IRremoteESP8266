...
String IRWhirlpoolAc::toString(void) {
  ...
  switch (this->getModel()) {
    case DG11J191: result += F(" (DG11J191)"); break;
    case DG11J13A: result += F(" (DG11J13A)"); break;
  ...
  switch (this->getCommand()) {
    case kWhirlpoolAcCommandLight:    result += F(" (Light)"); break;
    case kWhirlpoolAcCommandPower:    result += F(" (Power)"); break;
    case kWhirlpoolAcCommandTemp:     result += F(" (Temp)"); break;
    case kWhirlpoolAcCommandSleep:    result += F(" (Sleep)"); break;
    case kWhirlpoolAcCommandSuper:    result += F(" (Super)"); break;
    case kWhirlpoolAcCommandOnTimer:  result += F(" (On Timer)"); break;
    case kWhirlpoolAcCommandMode:     result += F(" (Mode)"); break;
    case kWhirlpoolAcCommandSwing:    result += F(" (Swing)"); break;
    case kWhirlpoolAcCommandIFeel:    result += F(" (IFeel)"); break;
    case kWhirlpoolAcCommandFanSpeed: result += F(" (Fan Speed)"); break;
    case kWhirlpoolAcCommand6thSense: result += F(" (6th Sense)"); break;
    case kWhirlpoolAcCommandOffTimer: result += F(" (Off Timer)"); break;
    default:                          result += F(" (UNKNOWN)");
  }
  return result;
}
