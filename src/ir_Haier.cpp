...
String IRHaierAC::toString(void) {
  ...
  result += F(" (");
  switch (cmd) {
    case kHaierAcCmdOff:         result += F("Off"); break;
    case kHaierAcCmdOn:          result += F("On"); break;
    case kHaierAcCmdMode:        result += F("Mode"); break;
    case kHaierAcCmdFan:         result += F("Fan"); break;
    case kHaierAcCmdTempUp:      result += F("Temp Up"); break;
    case kHaierAcCmdTempDown:    result += F("Temp Down"); break;
    case kHaierAcCmdSleep:       result += F("Sleep"); break;
    case kHaierAcCmdTimerSet:    result += F("Timer Set"); break;
    case kHaierAcCmdTimerCancel: result += F("Timer Cancel"); break;
    case kHaierAcCmdHealth:      result += F("Health"); break;
    case kHaierAcCmdSwing:       result += F("Swing"); break;
...
String IRHaierACYRW02::toString(void) {
  ...
  result += F(" (");
  switch (cmd) {
    case kHaierAcYrw02ButtonPower:    result += F("Power"); break;
    case kHaierAcYrw02ButtonMode:     result += F("Mode"); break;
    case kHaierAcYrw02ButtonFan:      result += F("Fan"); break;
    case kHaierAcYrw02ButtonTempUp:   result += F("Temp Up"); break;
    case kHaierAcYrw02ButtonTempDown: result += F("Temp Down"); break;
    case kHaierAcYrw02ButtonSleep:    result += F("Sleep"); break;
    case kHaierAcYrw02ButtonHealth:   result += "Health"; break;
    case kHaierAcYrw02ButtonSwing:    result += F("Swing"); break;
    case kHaierAcYrw02ButtonTurbo:    result += F("Turbo"); break;
    default:                          result += F("UNKNOWN");
  }
  result += ')';
  ...
  result += F(" (");
  switch (getTurbo()) {
    case kHaierAcYrw02TurboOff:  result += F("Off"); break;
    case kHaierAcYrw02TurboLow:  result += F("Low"); break;
    case kHaierAcYrw02TurboHigh: result += F("High"); break;
    default:                     result += F("UNKNOWN");
  }
  result += ')';
  result += addIntToString(getSwing(), F("Swing"));
  result += F(" (");
  switch (getSwing()) {
    case kHaierAcYrw02SwingOff:    result += F("Off"); break;
    case kHaierAcYrw02SwingAuto:   result += F("Auto"); break;
    case kHaierAcYrw02SwingBottom: result += F("Bottom"); break;
    case kHaierAcYrw02SwingDown:   result += F("Down"); break;
    case kHaierAcYrw02SwingTop:    result += F("Top"); break;
    case kHaierAcYrw02SwingMiddle: result += F("Middle"); break;
    default:                       result += F("UNKNOWN");
  }
  result += ')';
  result += addBoolToString(getSleep(), F("Sleep"));
