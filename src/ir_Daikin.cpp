...
String IRDaikinESP::toString(void) {
  ...
  switch (this->getCurrentDay()) {
    case 1: result +=F("Sun"); break;
    case 2: result +=F("Mon"); break;
    case 3: result +=F("Tue"); break;
    case 4: result +=F("Wed"); break;
    case 5: result +=F("Thu"); break;
    case 6: result +=F("Fri"); break;
    case 7: result +=F("Sat"); break;
