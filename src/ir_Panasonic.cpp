...
String IRPanasonicAc::toString(void) {
  ...
  switch (getModel()) {
    case kPanasonicDke: result += F(" (DKE)"); break;
    case kPanasonicJke: result += F(" (JKE)"); break;
    case kPanasonicNke: result += F(" (NKE)"); break;
    case kPanasonicLke: result += F(" (LKE)"); break;
    case kPanasonicCkp: result += F(" (CKP)"); break;
    case kPanasonicRkr: result += F(" (RKR)"); break;
  ...
  switch (getSwingVertical()) {
    case kPanasonicAcSwingVAuto:    result += F(" (Auto)"); break;
    case kPanasonicAcSwingVHighest: result += F(" (Full Up)"); break;
    case kPanasonicAcSwingVLowest:  result += F(" (Full Down)"); break;
    case 2:
    case 3:
    case 4: break;
    default:                        result += F(" (UNKNOWN)");
  ...
  switch (getModel()) {
    ...
    default:
      ...
      switch (getSwingHorizontal()) {
        case kPanasonicAcSwingHAuto:      result += F(" (Auto)"); break;
        case kPanasonicAcSwingHFullLeft:  result += F(" (Full Left)"); break;
        case kPanasonicAcSwingHLeft:      result += F(" (Left)"); break;
        case kPanasonicAcSwingHMiddle:    result += F(" (Middle)"); break;
        case kPanasonicAcSwingHFullRight: result += F(" (Full Right)"); break;
        case kPanasonicAcSwingHRight:     result += F(" (Right)"); break;
