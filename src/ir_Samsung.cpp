...
String IRSamsungAc::toString(void) {
  ...
  switch (getFan()) {
    case kSamsungAcFanAuto:
    case kSamsungAcFanAuto2: result += F(" (Auto)"); break;
    case kSamsungAcFanLow:   result += F(" (Low)"); break;
    case kSamsungAcFanMed:   result += F(" (Medium)"); break;
    case kSamsungAcFanHigh:  result += F(" (High)"); break;
    case kSamsungAcFanTurbo: result += F(" (Turbo)"); break;
