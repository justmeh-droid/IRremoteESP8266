...
String IRMitsubishiHeavy152Ac::toString(void) {
  ...
  result += F(" (");
  switch (this->getFan()) {
    case kMitsubishiHeavy152FanAuto:  result += F("Auto"); break;
    case kMitsubishiHeavy152FanHigh:  result += F("High"); break;
    case kMitsubishiHeavy152FanLow:   result += F("Low"); break;
    case kMitsubishiHeavy152FanMed:   result += F("Medium"); break;
    case kMitsubishiHeavy152FanMax:   result += F("Max"); break;
    case kMitsubishiHeavy152FanEcono: result += F("Econo"); break;
    case kMitsubishiHeavy152FanTurbo: result += F("Turbo"); break;
    default:                          result += F("UNKNOWN");
  }
  result += ')';
  result += addIntToString(getSwingVertical(), F("Swing(V)"));
  switch (this->getSwingVertical()) {
    case kMitsubishiHeavy152SwingVAuto:    result += F(" (Auto)"); break;
    case kMitsubishiHeavy152SwingVHighest: result += F(" (Highest)"); break;
    case kMitsubishiHeavy152SwingVHigh:    result += F(" (High)"); break;
    case kMitsubishiHeavy152SwingVMiddle:  result += F(" (Middle)"); break;
    case kMitsubishiHeavy152SwingVLow:     result += F(" (Low)"); break;
    case kMitsubishiHeavy152SwingVLowest:  result += F(" (Lowest)"); break;
    case kMitsubishiHeavy152SwingVOff:     result += F(" (Off)"); break;
    default:                               result += F(" (UNKNOWN)");
  }
...
String IRMitsubishiHeavy88Ac::toString(void) {
  ...
  result += F(" (");
  switch (this->getFan()) {
    case kMitsubishiHeavy88FanAuto:  result += F("Auto"); break;
    case kMitsubishiHeavy88FanHigh:  result += F("High"); break;
    case kMitsubishiHeavy88FanLow:   result += F("Low"); break;
    case kMitsubishiHeavy88FanMed:   result += F("Medium"); break;
    case kMitsubishiHeavy88FanEcono: result += F("Econo"); break;
    case kMitsubishiHeavy88FanTurbo: result += F("Turbo"); break;
    default:                         result += F("UNKNOWN");
  }
  result += ')';
  result += addIntToString(getSwingVertical(), F("Swing(V)"));
  switch (this->getSwingVertical()) {
    case kMitsubishiHeavy88SwingVAuto:    result += F(" (Auto)"); break;
    case kMitsubishiHeavy88SwingVHighest: result += F(" (Highest)"); break;
    case kMitsubishiHeavy88SwingVHigh:    result += F(" (High)"); break;
    case kMitsubishiHeavy88SwingVMiddle:  result += F(" (Middle)"); break;
    case kMitsubishiHeavy88SwingVLow:     result += F(" (Low)"); break;
    case kMitsubishiHeavy88SwingVLowest:  result += F(" (Lowest)"); break;
    case kMitsubishiHeavy88SwingVOff:     result += F(" (Off)"); break;
    default:                              result += F(" (UNKNOWN)");
  }
  result += addIntToString(getSwingHorizontal(), F("Swing(H)"));
  switch (this->getSwingHorizontal()) {
