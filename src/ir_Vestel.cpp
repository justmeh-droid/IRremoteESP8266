...
String IRVestelAc::toString(void) {
  ...
  switch (this->getFan()) {
    case kVestelAcFanAuto:     result += F(" (Auto)"); break;
    case kVestelAcFanLow:      result += F(" (Low)"); break;
    case kVestelAcFanMed:      result += F(" (Medium)"); break;
    case kVestelAcFanHigh:     result += F(" (High)"); break;
    case kVestelAcFanAutoCool: result += F(" (Auto Cool)"); break;
    case kVestelAcFanAutoHot:  result += F(" (Auto Hot)"); break;
